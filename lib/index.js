...
class DingTalk {
  ...
  _request(method, path, data, key) {
    return this.httpUtil.request(method, path, data).then(ret => {
  ...
  _get(path, data, key) {
    return this._request('GET', path, data, key);
  }

  _post(path, data, key) {
    return this._request('POST', path, data, key);
  }
